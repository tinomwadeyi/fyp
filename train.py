...
takeImg = tk.Button(window, text="Take Images", command=TakeImages, fg="white", bg="red", width=10, height=1,
                    activebackground="Red", font=('times', 15, ' bold '))
takeImg.place(x=55, y=400)
trainImg = tk.Button(window, text="Train Images", command=TrainImages, fg="white", bg="red", width=12, height=1,
                     activebackground="Red", font=('times', 15, ' bold '))
trainImg.place(x=275, y=400)
trackImg = tk.Button(window, text="Track Images", command=TrackImages, fg="white", bg="red", width=12, height=1,
                     activebackground="Red", font=('times', 15, ' bold '))
trackImg.place(x=500, y=400)
quitWindow = tk.Button(window, text="Quit", command=window.destroy, fg="white", bg="red", width=5, height=1,
                       activebackground="Red", font=('times', 15, ' bold '))
quitWindow.place(x=705, y=400)
